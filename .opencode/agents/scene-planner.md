---
description: Erstellt detaillierte Szenenpläne für einzelne Kapitel — teilt das Kapitel in Szenen auf und definiert POV, Ort, Beats, emotionalen Bogen und Hooks.
mode: subagent
permission:
  edit: allow
  bash: deny
