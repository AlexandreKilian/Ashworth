---
description: Bewertet geschriebene Szenen nach 5 Kriterien (1-5 Skala) — prüft Klarheit, Pacing, Charakterstimme, Spannung und Regelkonformität sowie Konsistenz mit Plot und Glossar.
mode: subagent
permission:
  edit: allow
  bash: deny
