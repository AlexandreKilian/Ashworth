---
szene: K04-S03
titel: "Zwei Beobachter"
datum: 2026-04-09
reviewer: Scene Reviewer
status: Akzeptiert
---

# Review — K04-S03: Zwei Beobachter
...
| Wort/Muster | Fundstelle | Bewertung |
|-------------|-----------|-----------|
| „irgendwo" | Z. 19: „Ein Auto fuhr irgendwo auf der *Marsh Road*" | **Verboten** laut Stilregeln. Vorschlag: „Ein Auto fuhr auf der *Marsh Road*" oder „Ein Auto fuhr in der Ferne über die *Marsh Road*". |
...
- Durchgehend stark. Emotionen werden über Körpersprache gezeigt: Herz hämmert, Finger pressen sich ums Skizzenbuch, Finger zittern, Bleistift umklammert ohne es zu merken.
- Der innere Monolog in Zeile 83 (*Danke war falsch. Lass uns das zusammen machen war zu viel.*) ist erlaubtes Show-through-Thought — keine Regelverletzung.
- Die Metapher "Puzzleteile auf zwei verschiedenen Tischen" (Z. 77) ist treffend und frisch — kein Klischee.

### Charakter-Konsistenz (vs. Glossar)
...
- **Hören:** Kanalwasser gluckern (Z. 18), Auto auf der Marsh Road (Z. 19), Laub rascheln (Z. 41, 69), Wind durch Weidenzweige (Z. 73), Hund bellt (Z. 96) — gut.
- **Sehen:** Archies Skizzenbuch im Laternenschein (Z. 43), Zeichnungen mit Markierungen — gut.
- **Tasten:** Feuchtigkeit durch Hosenstoff (Z. 19), Knie brennt (Z. 19), feuchter Boden/weiches Laub (Z. 26) — gut.
- Drei Sinne abgedeckt, Minimum erfüllt.

### Szenenplan-Abgleich

| Plan-Element | Umgesetzt? | Anmerkung |
|-------------|-----------|-----------|
| Ort: unter den Trauerweiden | ✓ | |
...
| Squire-Schloss Detail | ✓ | Z. 67 — stimmig mit Archies Glossar (Schlösser-Expertise via Grandpa Ted) |
| Wortanzahl ~900 | ✓ | ~900 Wörter (Fließtext) |
...
1. **Z. 19 — Verbotenes Wort „irgendwo" ersetzen:**
   - Aktuell: „Ein Auto fuhr irgendwo auf der *Marsh Road*"
   - Vorschlag: „Ein Auto fuhr auf der *Marsh Road*" oder „Ein Auto fuhr in der Ferne über die *Marsh Road*"

2. **Z. 45–48 — Optional straffen:** Die Aufzählung der Zeichnungen (zweite, dritte, vierte + Zusammenfassung) könnte um 1–2 Sätze gekürzt werden, da der Leser das Prinzip nach der zweiten Zeichnung verstanden hat. Kein Muss, aber eine Möglichkeit, das Pacing im Mittelteil zu schärfen.

3. **Optional — Bedrohungsgefühl:** Ein kurzer Moment (1–2 Sätze), in dem einer der beiden glaubt, etwas auf dem Weg zu hören, würde die Gefahr des Badehaus-Eindringlings präsenter halten. Z.B. nach dem Informationsaustausch (vor Z. 75), ein Geräusch, das sich als Wind entpuppt. Nicht zwingend, aber es würde die Spannung heben.
...
Die Szene erfüllt alle Kriterien (alle >= 3, Durchschnitt >= 3,5). Ein verbotenes Wort muss korrigiert werden (Z. 19: „irgendwo"). Die optionalen Vorschläge (Straffung Mittelteil, Bedrohungsmoment) sind Feinschliff, keine Voraussetzung für die Akzeptanz.
