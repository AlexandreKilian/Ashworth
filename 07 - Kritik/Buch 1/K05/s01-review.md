...
kapitel: "05"
szene: "01"
titel: "Flüstern auf dem Schulhof"
datum: 2026-04-09
status: review
---

# Review — K05-S01: Flüstern auf dem Schulhof
...
Priya klingt weitgehend authentisch. Ihre trockene Begrüßung ("Guten Morgen dir auch.") passt zu ihrer praktischen Art. Ihre sofortigen, präzisen Fragen ("Wann genau?", "Wie oft?") zeigen die Macherin. Auch ihre innere Stimme funktioniert: das Durchrechnen der Pflichten, der Gedanke an den Vater.

**Verbesserungspotenzial:** Priyas Glossar-Eintrag betont ihre soziale Cleverness und ihren Einfallsreichtum. In der Szene bleibt sie etwas passiver als erwartet — sie stellt Fragen, aber das "Durchrechnen" von Alternativen oder ein kurzer Moment, in dem sie versucht, eine Lösung zu finden (bevor sie aufgibt), würde ihren Charakter schärfer zeigen.

> **Vorschlag:** Nach "Ich weiß nicht, ob ich kann" könnte ein kurzer innerer Gedanke stehen, der zeigt, dass sie bereits nach einem Ausweg sucht — z.B. ob sie die Lieferung vorziehen oder jemanden einspannen könnte — bevor die Aussichtslosigkeit sie einholt.
...
- Dritte Person, enger POV (Priya) ohne Brüche
- Deutsche Anführungszeichen korrekt
- Keine verbotenen Wörter (kein "plötzlich", "irgendwie", "bemerkte dass", "begann zu", "fing an zu")
- Show don't Tell überwiegend gut umgesetzt (gerissene Jacke statt "er hatte Angst", Finger um Brotdose statt "sie war nervös")
- Kursiv für innere Gedanken (*Freitag.*)
- Dialog knapp und figurenspezifisch
...
Gut umgesetzt. Besonders gelungen:
- "Priyas Finger schlossen sich fester um die Brotdose." (Anspannung)
- "Er kaute auf gar nichts." (Aufregung — Abweichung vom Normalmuster)
- "Er zeigte ihr den Riss in seiner Wachsjacke als Beweis" — der Riss kommuniziert Gefahr stärker als jede Erklärung.
- "Die Entfernung zwischen ihnen wuchs mit jedem Schritt." (Priyas Angst, ausgeschlossen zu werden)

Kein Tell-Problem identifiziert.
