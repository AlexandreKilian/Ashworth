...
Am Schwimmbecken vergleicht er Maße und stellt fest: Die **Wand am tiefen Ende ist dreieinhalb Meter zu dick**. Die Außenmauer misst einen halben Meter, die Innendifferenz ergibt einen Hohlraum, der auf keinem Plan existiert.
...
### Geöffnet
- Verborgene Luke im Beckenboden — wohin führen die Steinstufen?
- Zweiter Nebenraum (sauber gewischt) — was wird dort gelagert/getan?
- Die zu dicke Wand — verbirgt einen Hohlraum, der mit den Tunneln zusammenhängen muss
- Zwei verschiedene Gerüche = zwei verschiedene Systeme: chemisch (Schmuggler/viktorianischer Keller) vs. feuchter Stein (Lagerhaus-Tunnel/18. Jh.)

### Geschlossen/Vorangetrieben
- Grundriss des Badehauses vervollständigt (Archies Hauptaufgabe seit K06)
- Fun-and-Games-Beat fortgesetzt: Archies Solo-Talent gezeigt
- Verbindung Badehaus ↔ Lagerhauszeit bestätigt (Teds Hinweis aus K07)

## Emotionaler Zustand am Ende

**Archie:** Wach, aufgeladen, voller Entdeckerdrang. Das Skizzenbuch liegt auf seiner Brust, der Grundriss zeigt eine Treppe, die nicht existieren sollte. Er will schlafen, kann nicht. Morgen wird er es den anderen zeigen. Das Geheimnis gehört nicht ihm allein — es gehört der Gruppe.

## Wichtige Reveals / Neue Informationen

- Zweiter Nebenraum hinter den Umkleiden (sauber gewischt, genutzt — von wem?)
- Wand am tiefen Beckenende ist 3,5 Meter zu dick — Hohlraum dahinter
- Verborgene Holzluke im Beckenboden mit Eisenring (18. Jh., Lagerhauszeit)
- Zweite Kellertreppe: Steinstufen, steil, abgetreten, Geruch nach feuchtem Stein (nicht Chemie)
- Zwei Zugänge zum Untergrund: bekannte viktorianische Kellertreppe (chemisch, Schmuggler) und verborgene Lagerhaus-Treppe (alt, vergessen?)
